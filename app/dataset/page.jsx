...
const columns = [
	{
		name: 'Administrative',
		description: 'Number of pages visited by the user about account management.',
	},
	{
		name: 'Administrative_Duration',
		description: 'Total time spent on administrative pages.',
	},
	{
		name: 'Informational',
		description: 'Number of informational pages visited by the user.',
	},
	{
		name: 'Informational_Duration',
		description: 'Total time spent on informational pages.',
	},
	{
		name: 'ProductRelated',
		description: 'Number of product-related pages visited by the user.',
	},
	{
		name: 'ProductRelated_Duration',
		description: 'Total time spent on product-related pages.',
	},
	{
		name: 'BounceRates',
		description: 'Average bounce rate value of the pages visited by the user.',
	},
	{
		name: 'ExitRates',
		description: 'Average exit rate value of the pages visited by the user.',
	},
	{
		name: 'PageValues',
		description:
	...
	{
		name: 'Region',
		description: 'Geographical region from which the session has been started.',
	},
	{ name: 'TrafficType', description: 'Type of traffic source.' },
	{
		name: 'VisitorType',
		description: 'Type of visitor: Returning_Visitor, New_Visitor, or Other.',
	},
	{ name: 'Weekend', description: 'Indicates if the visit was on the weekend.' },
	{
		name: 'Revenue',
		description: 'Class label: True if the user made a purchase, False otherwise.',
	},
];
		...
		<main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
			<div className="max-w-3xl w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
				...
				<p className="text-gray-700 dark:text-gray-200 mb-6 text-center">
					This dataset consists of user sessions on an e-commerce website, with
					features such as page values, bounce rates, exit rates, and more. The
					target is whether the user made a purchase. It is commonly used for
					predicting purchasing intention using machine learning models.
				</p>
